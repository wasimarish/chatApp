...
//                         const chatIndex=userChatData.chatsData.findIndex((c)=>messageId===messagesId);
...
//             <div className="chat-msg">
//                 <div className="s-msg">
//                     <p className="msg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum dolore doloremque exercitationem tempora aliquam!</p>
//                     <div>
...
//         <div className="chat-input">
//             <input onChange={(e)=>setInput(e.target.value)} valur={input}type="text" placeholder='Send A Message' />
